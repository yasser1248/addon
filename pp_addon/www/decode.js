            ...
            372: (e, t, n) => {
                    ...
                    constructor() {
                        ...
                        this.postis = function (e) {
                            ...
                            var h = {
                                    ...
                                    send: function (e) {
                                        var t = e.method;
                                        (l || e.method === u) && r && "function" == typeof r.postMessage ? r.postMessage(JSON.stringify({
                                            postis: !0,
                                            scope: n,
                                            method: t,
                                            params: e.params
                                    ...
                                    destroy: function (e) {
                                        clearInterval(t), l = !1, i && "function" == typeof i.removeEventListener && i.removeEventListener("message", p), e && e()
                                    }
                                },
                            ...
                            ...f,
                            ...e
                        }), this._receiveCallback = () => {}, this.postis.listen(v, (e => this._receiveCallback(e)))
                    }
                    dispose() {
                        this.postis.destroy()
                    }
                ...
                class w {
                    ...
                    _onMessageReceived(e) {
                        ...
                        } else e.type === _ ? this.emit("request", e.data, ((t, n) => {
                            this._backend.send({
                                type: b,
                                error: n,
                                id: e.id,
                ...
                class P extends(i()) {
                    constructor(e) {
                        ...
                        }(n), C = o.getItem("jitsiLocalStorage");
                        this._parentNode = c, this._url = function (e) {
                            ...
                            release: L
                        }), this._createIFrame(a, s, h, k), this._transport = new w({
                            backend: new y({
                                postisOptions: {
                        ...
                        }), Array.isArray(g) && g.length > 0 && this.invite(g), this._tmpE2EEKey = b, this._isLargeVideoVisible = !1, this._isPrejoinVideoVisible = !1, this._numberOfParticipants = 0, this._participants = {}, this._myUserID = void 0, this._onStageParticipant = void 0, this._setupListeners(), R++
                    }
                    _createIFrame(e, t, n, r) {
                        const i = `jitsiConferenceFrame${R}`;
                        this._frame = document.createElement("iframe"), this._frame.allow = ["autoplay", "camera", "clipboard-write", "compute-pressure", "display-capture", "hid", "microphone", "screen-wake-lock"].join("; "), this._frame.name = i, this._frame.id = i, this._setSize(e, t), this._frame.setAttribute("allowFullScreen", "true"), this._frame.style.border = 0, r && (this._frame.sandbox = r), n && (this._frame.onload = n), this._frame.src = this._url, this._frame = this._parentNode.appendChild(this._frame)
                    }
                    ...
                    _setupListeners() {
                        this._transport.on("event", (e => {
                            ...
                            case "participant-joined":
                                this._participants[r] = this._participants[r] || {}, this._participants[r].displayName = n.displayName, this._participants[r].formattedDisplayName = n.formattedDisplayName, j(this, 1);
                                break;
                            case "participant-left":
                                j(this, -1), delete this._participants[r];
                                break;
                    ...
                    if (!(t[s] < e.level))
                        for (var a = !(e.options.disableCallerInfo || r.disableCallerInfo) && i(), c = n.concat(e.transports), d = 0; d < c.length; d++) {
                            ...
                            if (u && "function" == typeof u) {
                                var p = [];
                                p.push((new Date).toISOString()), e.id && p.push("[" + e.id + "]"), a && a.methodName.length > 1 && p.push("<" + a.methodName + ">: ");
                                var h = p.concat(o);
                                try {
                                    u.bind(l).apply(l, h)
                                } catch (e) {
