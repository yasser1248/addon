...
scheduler_events = {
    ...
    "cron": {
        ...
        "0 18 * * 0,1,2,3,4": ["pp_addon.scheduler_tasks.employee_checkout.check_out"],
        "0 18 * * 0,1,2,3,4": ["pp_addon.scheduler_tasks.employee_checkin_checkout.employees_not_done_any_tasks"],
    },
    # 	"all": [
    # 		"pp_addon.tasks.all"
    # 	],
